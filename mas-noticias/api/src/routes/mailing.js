...
<div style="font-family: inherit; text-align: inherit"><span style="font-family: &quot;trebuchet ms&quot;, helvetica, sans-serif; font-size: 16px; color: #656565">Mas Noticias</span></div><div></div></div></td>
  ...
  const msg = {
    ...
    from: 'masnoticias.tucuman@gmail.com', // Change to your verified sender
...
<tbody>
  <tr>
    <td style="padding:40px 0px 30px 0px; line-height:36px; text-align:inherit; background-color:#212529;" height="100%" valign="top" bgcolor="#212529" role="module-content"><div><div style="font-family: inherit; text-align: center"><span style="font-size: 46px; color: #ffffff; font-family: &quot;trebuchet ms&quot;, helvetica, sans-serif"><strong>Mensaje de Usuario</strong></span></div><div></div></div></td>
  </tr>
</tbody>
</table><table class="module" role="module" data-type="text" border="0" cellpadding="0" cellspacing="0" width="100%" style="table-layout: fixed;" data-muid="efe5a2c4-1b11-49e7-889d-856d80b40f63.2" data-mc-module-version="2019-10-22">
<tbody>
  <tr>
    <td style="padding:50px 30px 30px 30px; line-height:28px; text-align:inherit; background-color:#ffffff;" height="100%" valign="top" bgcolor="#ffffff" role="module-content"><div><div style="font-family: inherit; text-align: inherit"><span style="font-size: 20px; font-family: &quot;trebuchet ms&quot;, helvetica, sans-serif; color: #656565">Hola!</span></div>
      <div style="font-family: inherit; text-align: inherit"><br></div>
      <div style="font-family: inherit; text-align: inherit"><span style="font-size: 20px; font-family: &quot;trebuchet ms&quot;, helvetica, sans-serif; color: #656565">Estimado Adiministrador: Ha recibido un mensaje de un usuario</span></div>
      </hr>
      <div style="font-family: inherit; text-align: inherit">El email del usuario es: <br>${message.email}</div>
      <div style="font-family: inherit; text-align: inherit">El nombre del usuario es: <br>${message.name}</div>
      <div style="font-family: inherit; text-align: inherit">El teléfono del usuario es: <br>${message.phone}</div>
      <div style="font-family: inherit; text-align: inherit">El Mensaje es: <br>${message.consult}</div>
      <div></div>
  </div></td>
  </tr>
</tbody>
      ...
      <td align="center" bgcolor="#FFFFFF" class="outer-td" style="padding:0px 0px 0px 30px; background-color:#FFFFFF;">
        <table border="0" cellpadding="0" cellspacing="0" class="wrapper-mobile" style="text-align:center;">
          <tbody>
            <tr>
            <td align="center" bgcolor="#FA3004" class="inner-td" style="border-radius:6px; font-size:16px; text-align:center; background-color:inherit;">
              <a href="http://localhost:3000/" style="background-color:#FA3004; border:0px solid 0; border-color:0; border-radius:0px; border-width:0px; color:#ffffff; display:inline-block; font-size:16px; font-weight:300; letter-spacing:0px; line-height:normal; padding:15px 5px 15px 5px; text-align:center; text-decoration:none; border-style:solid; font-family:trebuchet ms,helvetica,sans-serif;" target="_blank">Ir a la página</a>
            </td>
            </tr>
          </tbody>
        </table>
...
<div style="font-family: inherit; text-align: inherit"><span style="font-family: &quot;trebuchet ms&quot;, helvetica, sans-serif; font-size: 16px; color: #656565">Mas Noticias</span></div><div></div></div></td>
  ...
  const msg = {
    to: 'masnoticias.tucuman@gmail.com', // Change to your recipient
    from: 'masnoticias.tucuman@gmail.com', // Change to your verified sender
    subject: 'Consulta de Usuario',
    text: 'Consulta de un usuario',
    html
  };
  ...
  sgMail
    ...
    .then(() => {
      ...
      return res.send(`Mensaje enviado a  'masnoticias.tucuman@gmail.com'`)
    })
    .catch((error) => {
